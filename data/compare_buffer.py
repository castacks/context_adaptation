...
# fig = plt.figure()
# ax = fig.add_subplot(projection='3d')
# # ax.scatter(X_embedded[:,0], X_embedded[:,1], train_in[:,-2], c=train_in[:,-1])
# ax.scatter(X_embedded[:,0], X_embedded[:,1], train_in[:,-2], c=train_in[:,-1]/train_in[:,-1].max())
#
# plt.show()
